...
1. Give it a name and optional webhook URL
2. Activate it for your tenant and select the entity types you want (e.g., `Client`)
3. Download the **credential bundle** — it contains your Client ID, Client Secret, and Token Endpoint
4. Save the **signing key** shown on activation (displayed once)
...
| `WEBHOOK_SIGNING_KEY` | From the plugin activation screen |
