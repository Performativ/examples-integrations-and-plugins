...
Three core scenarios ([S1, S2, S3](SCENARIOS.md)) are implemented across three approaches:

| Approach | Description | Scenarios |
|----------|-------------|-----------|
| [curl/](curl/) | Shell scripts using curl -- simplest, no build tools | S1, S2, S3 |
| [java/manual](java/scenarios/) | Raw HTTP with `java.net.http` -- no dependencies beyond JDK | S1, S2, S3 |
| [java/generated](java/scenarios/) | OpenAPI-generated typed client -- strict spec conformance | S1, S2, S3 |
