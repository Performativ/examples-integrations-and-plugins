...
- Plugin credentials from the Performativ admin UI:
  - **Client ID** and **Client Secret** (from plugin registration)
  - **Webhook Signing Key** (from plugin activation, tunnel approach only)
...
1. Go to **Plugins > Your Plugin > Instances > Configure**
