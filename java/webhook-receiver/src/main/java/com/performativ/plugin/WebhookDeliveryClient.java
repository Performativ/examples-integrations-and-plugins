...
public final class WebhookDeliveryClient {
     ...
     *
     * <p>API endpoint:
     * {@code GET /api/v1/plugins/{slug}/instances/{instanceId}/webhook-deliveries}
     *
     ...
     *
     * <p>API endpoint:
     * {@code POST /api/v1/plugins/{slug}/instances/{instanceId}/webhook-deliveries/{deliveryId}/replay}
     *
